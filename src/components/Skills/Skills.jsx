...
//   // Handle all cases: loading, error, empty data, no data
//   if (loading) {
//     return (
//       <section id="skills" className="skills">
//         <div className="container">
...
//             <p>{error}</p>
//             <button onClick={fetchSkills} className="btn btn-secondary">
//               Retry
//             </button>
//           </div>
//         </div>
...
//     return null; // Don't render the section if no skills data
//   }
...
//             if (!category || !category.category || !category.items || !Array.isArray(category.items)) {
//               console.warn('Invalid category data at index:', index, category);
//               return null; // Skip invalid categories
//             }
            
//             return (
//               <div key={category.category || index} className="skill-category">
//                 <h3>{category.category}</h3>
//                 <div className="skills-grid">
//                   {category.items.map((skill, skillIndex) => (
//                     <div key={skill || skillIndex} className="skill-item">
...
//                         className="progress-bar"
//                         style={{
//                           width: `${Math.random() * 20 + 80}%` // Simulated proficiency
//                         }}
//                       ></div>
//                     </div>
//                     <span className="skill-name">{skill}</span>
