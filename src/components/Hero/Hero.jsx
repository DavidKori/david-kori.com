...
//       const resumeUrl =await axios.get("/resume")
//       setProfile(response.data);
//       setResume(resumeUrl.data)
...
//           <div className="hero-text">
//             <h1 className="hero-title">
//               Hi, I'm <span className="gradient-text">{profile.fullName}</span>
//             </h1>
//             <h2 className="hero-subtitle">{profile.professionalTitle}</h2>
...
//         <div className="tech-scroll">
//           <div className="tech-list">
//             {['React', 'Node.js', 'MongoDB', 'Express', 'JavaScript', 'TypeScript'].map((tech) => (
